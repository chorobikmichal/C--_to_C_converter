...
void copyAndRenameFunc(node* n,char structName[100]){
    int nodeCount=0,varCount=-1;
    char funcName[100];
    char funcVars[100];
    char funcNewName[100];
    char funcPointer[100];

    char variablesStr[100];
    strcpy(variablesStr," ");
...
void addFunction(node* n,char funcNewName[100],char funcPointer[100],char structName[100]){
