...
Compilation:
run the Makefile located in the A1 folder

Usage:
To use this program input the name of a C++ file the you want converted into C. In order to do that after compiling 
the progran write ./a1 followed by a space and the name of the C++ program. The C++ file that you want to convert into C has 
